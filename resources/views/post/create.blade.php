      ...
      <div class="overflow-hidden bg-white p-8 shadow-sm sm:rounded-lg">
        ...
        >
          ...
          <div class="flex flex-row gap-2">
            <x-primary-button class="self-start">Post Now</x-primary-button>
            <!-- Schedule Button -->
            <x-secondary-button disabled onclick="showScheduleModal()">
              Schedule (not working yet)
            </x-secondary-button>
